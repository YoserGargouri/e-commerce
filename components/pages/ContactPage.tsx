    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 gap-12 mb-12">
          <div>
            <h2 className="text-2xl font-bold text-[#8B7355] mb-6">Trouvez-nous sur la carte</h2>
            <div className="bg-gray-100 rounded-lg overflow-hidden h-96 flex items-center justify-center border border-gray-300">
              <iframe
                width="100%"
                height="100%"
                style={{ border: 0 }}
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#8B7355] mb-6">Contactez-nous</h2>
            ...
            <button
              ...
              className="w-full bg-[#c3aa8c] hover:bg-[#b39977] text-white font-medium py-3 rounded-lg transition-colors"
            >
              Envoyer le message
            </button>
